...
@Table(
	name = "levantamentos", 
	indexes = @Index(name = "idx_levantamentos_numero_ordem", columnList = "numero_ordem"),
	uniqueConstraints = @UniqueConstraint(name = "uk_levantamentos_numero_ordem", columnNames = "numero_ordem")
)
